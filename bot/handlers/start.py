...
async def cmd_help(message: types.Message):
    ...
    text = (
        ...
        "1. Instagram yoki YouTube ilovasidan videoning <b>ulashish (share)</b> tugmasini bosing.\n"
        "2. <b>Nusxa olish (copy link)</b> qilib, havolani ushbu botga yuboring.\n"
        "3. Bot videoni yuklab, sizga toza holda yuboradi.\n\n"
